...
class UnitTest(unittest.TestCase):
    ...
    def test_get_shipment(self):
        ...
        self.assertEqual(len(resp.data["results"]), resp.data["page_size"])
    ...
    def test_post_shipment(self):
        ...
        resp = self.client.post(
            "/api/v1/shipment/", data=object, content_type="application/json"
        )
        self.assertEqual(resp.status_code, 200)
        self.assertEqual(
    ...
    def test_put_shipment_id(self):
        ...
        self.assertEqual(resp.status_code, 200)
        self.assertEqual(
            all([object[key] == resp.json()[key] for key in object.keys()]),
            True
        )
